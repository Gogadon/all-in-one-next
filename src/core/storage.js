...
export function exportBackup(state){return JSON.stringify({app:'all-in-one-rebuild',version:'0.1.0',exportedAt:new Date().toISOString(),data:validate(state)},null,2)}
