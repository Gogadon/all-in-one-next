...
export function exportBackup(state){return JSON.stringify({app:'all-in-one-rebuild',version:'0.2.2',exportedAt:new Date().toISOString(),data:validate(state)},null,2)}
